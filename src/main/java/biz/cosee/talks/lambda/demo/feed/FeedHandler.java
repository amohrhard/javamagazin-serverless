...
public class FeedHandler implements RequestHandler<FeedRequest, FeedResponse> {
    ...
    public FeedResponse handleRequest(FeedRequest feedRequest, Context context) {
        ...
        List<Picture> pictureForResponse = getPicturesSinceTimestamp(mapper, feedRequest.since);
    ...
    private List<Picture> getPicturesSinceTimestamp(DynamoDBMapper mapper, long since) {
