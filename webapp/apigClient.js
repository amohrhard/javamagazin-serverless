...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://is7zz8pxk8.execute-api.eu-west-1.amazonaws.com/prod';
    ...
    apigClient.feedGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['since'], ['body']);
        
        var feedGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/feed').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['since']),
            body: body
        };
